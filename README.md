...
- Library Tools provides a validated installation queue, structured local history, saved-search watchlists, provider capability health, and privacy-safe diagnostic export.
